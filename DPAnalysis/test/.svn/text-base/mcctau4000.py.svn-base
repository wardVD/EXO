...
def DrawHist(string,bkg,signal,data,stack,cmslabel,sqrtlabel):
    ...
    cmslabel.Draw("same")
    sqrtlabel.Draw("same")
    c1.SaveAs(string+"ctau4000.pdf")

#saving the maps: 0-5:bkg, 6: signal, 7-8:data
maplist = ["bkg120to170.root","bkg170to300.root","bkg300to470.root","bkg470to800.root","bkg50to80.root","bkg80to120.root","Signalctau4000.root","Run2012Cdata.root","Run2012Ddata.root"]
